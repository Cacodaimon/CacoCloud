angular.module('caco.feed', ['ui.router', 'caco.feed.crtl', 'caco.feed.filter'])
    .config(function($stateProvider) {
        $stateProvider
            ...
            .state('queue',                        {                                     templateUrl: 'views/feed/main/queue.html',             controller: 'ItemQueueMainCrtl' })
            .state('queue.item',                   {url: '/feed/show/item/queue',        templateUrl: 'views/feed/main/item.html',              controller: 'ItemQueueCrtl'     })
